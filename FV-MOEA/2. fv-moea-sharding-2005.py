...
# 保存数据到CSV
def save_data_to_csv(hv_values, throughput_values, delay_values, security_values, filename="simulation_results.csv"):
    data = {
...
def fv_moea(pop_size, num_generations, num_nodes, num_shards):
    ...
    for gen in range(num_generations):
        ...
        while len(offspring) < pop_size:
            ...
            # 变异操作
            tools.mutUniformInt(child1, 1, num_shards, indpb=0.05)
            tools.mutUniformInt(child2, 1, num_shards, indpb=0.05)
