...
def calculate_reference_point(objectives):
    ...
    for i in range(num_objectives):
        if i == 0:
            ...
            reference_point.append(max_value + 0.1)
        elif i == 1:
            min_value = max(ind[i] for ind in objectives)
            reference_point.append(min_value + 0.1)
        elif i == 2:
            min_value = max(ind[i] for ind in objectives)
            reference_point.append(min_value + 1)
